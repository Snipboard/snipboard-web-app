  ...
  return (
    <div className="relative bg-zinc-800 border-black shadow-xl border-4 p-4 rounded-xl">
      <div className="flex justify-between items-center mb-2">
        ...
        <button 
          onClick={handleCopy} 
          className="absolute top-4 right-4 bg-[#1E1E1E] hover:bg-[#121212] text-white text-sm px-4 py-2 rounded-l flex items-center justify-center" 
          style={{ width: '100px' }}
        >
      ...
      <SyntaxHighlighter language={language} style={vscDarkPlus} className="dark-scrollbar">
        {code}
      </SyntaxHighlighter>
      ...
      <div className={`mt-2 text-white p-4 bg-[#2E2E2E] rounded-lg description ${expanded ? 'expanded' : ''}`}>
