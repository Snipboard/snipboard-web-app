  ...
  return (
    <div className="relative bg-zinc-800 border-black shadow-xl border-4 p-4 rounded-xl">
      <div className="flex justify-between items-center mb-3">
        ...
        <button 
          onClick={handleCopy} 
          className="absolute top-4 right-4 bg-codeBg hover:bg-darkCodeBg text-white text-sm px-4 py-2 rounded flex items-center justify-center" 
          style={{ width: '100px' }}
        >
      ...
      <div className="flex justify-between items-center mt-2">
        ...
        <div className="flex space-x-2">
          <button onClick={toggleExpanded} className="bg-codeBg hover:bg-darkCodeBg text-white text-sm px-4 py-2 rounded flex items-center">
            <FaBars className="mr-2" /> {expanded ? 'Less' : 'More'}
          </button>
          <button className="bg-codeBg hover:bg-darkCodeBg text-white text-sm px-4 py-2 rounded flex items-center">
            <FaEdit className="mr-2" /> Edit
          </button>
        </div>
      </div>
      <div className={`mt-2 text-white bg-lightCodeBg rounded-lg description ${expanded ? 'expanded' : ''}`}>
